        ...
        <div style="padding:2rem;">
          <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:1rem; margin-bottom:2rem;">
            <div style="text-align:center; padding:1.5rem; background:var(--white-soft); border-radius:var(--radius-md);">
              <span style="font-size:2rem; font-weight:900; background:var(--gold-gradient); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;">${parts.length}</span>
              <p style="font-size:0.85rem; color:var(--text-muted);">${lang === 'ar' ? 'قطعة' : 'Parts'}</p>
            </div>
            <div style="text-align:center; padding:1.5rem; background:var(--white-soft); border-radius:var(--radius-md);">
              <span style="font-size:2rem; font-weight:900; background:var(--gold-gradient); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;">${faults.length}</span>
              <p style="font-size:0.85rem; color:var(--text-muted);">${lang === 'ar' ? 'عطل شائع' : 'Common Faults'}</p>
            </div>
            <div style="text-align:center; padding:1.5rem; background:var(--white-soft); border-radius:var(--radius-md);">
              <span style="font-size:2rem; font-weight:900; background:var(--gold-gradient); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;">
          ...
          <div style="display:grid; grid-template-columns:repeat(auto-fill,minmax(200px,1fr)); gap:0.75rem; margin-bottom:2rem;">
            ${parts.map(part => `
              ...
              " onmouseover="this.style.borderColor='rgba(201,168,76,0.3)'"
                ...
                <div style="width:36px; height:36px; background:var(--gold-gradient); border-radius:8px; display:flex; align-items:center; justify-content:center; font-size:0.9rem; color:var(--black); flex-shrink:0;">
        ...
        <ol style="display:flex; flex-direction:column; gap:0.5rem; margin-bottom:2rem; padding:0; counter-reset:solution-counter;">
          ${(fault.solutions[lang] || fault.solutions.ar || []).map((sol, i) => `
            <li style="display:flex; align-items:flex-start; gap:0.75rem; padding:0.875rem 1rem; background:rgba(45,106,79,0.05); border-radius:var(--radius-sm); border-right:3px solid var(--success);">
              <span style="width:24px; height:24px; background:var(--gold-gradient); border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:0.75rem; font-weight:700; color:var(--black); flex-shrink:0;">${i + 1}</span>
    ...
    if (sidebarEl) {
      sidebarEl.innerHTML = `
        ...
        <div class="sidebar-card">
          ...
          <div style="text-align:center; padding:1rem 0;">
            <span style="font-size:1.5rem; font-weight:900; background:var(--gold-gradient); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;">
